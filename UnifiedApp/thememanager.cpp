...
QString ThemeManager::analyticsStyleBlock() const
{
    if (isDark()) {
        return "<style>"
               "body { color: #c4c7cc; font-family: 'JetBrains Mono', 'Fira Code', 'Consolas', 'Monaco', monospace; font-size: 13px; }"
               ".header { color: #00BCD4; font-size: 14px; font-weight: bold; letter-spacing: 2px; }"
               ".subheader { color: #9aa0a6; font-size: 12px; margin-top: 4px; }"
               ".component { margin: 8px 0; padding: 10px; background: #1c1e26; border-radius: 6px; border-left: 3px solid #3a3f4b; }"
               ".component-name { color: #e8eaed; font-weight: bold; font-size: 14px; }"
               ".stat { color: #9aa0a6; font-size: 12px; }"
        ...
        return "<style>"
               "body { color: #374151; font-family: 'JetBrains Mono', 'Fira Code', 'Consolas', 'Monaco', monospace; font-size: 13px; }"
               ".header { color: #0097A7; font-size: 14px; font-weight: bold; letter-spacing: 2px; }"
               ".subheader { color: #6B7280; font-size: 12px; margin-top: 4px; }"
               ".component { margin: 8px 0; padding: 10px; background: #F3F4F6; border-radius: 6px; border-left: 3px solid #D1D5DB; }"
               ".component-name { color: #1A1D23; font-weight: bold; font-size: 14px; }"
