...
"""
    ...
    add_content_slide(prs, "Complete Usage Workflow", [
        ...
        "• Step 2: Login",
        {"text": "Commander (Commander/designer) for design mode", "level": 1},
        {"text": "Operator (Operator/user) for runtime monitoring", "level": 1},
        "• Step 3: Design System (Commander mode)",
