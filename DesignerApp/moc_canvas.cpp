...
QT_MOC_LITERAL(1, 7, 14), // "componentAdded"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 2), // "id"
QT_MOC_LITERAL(4, 26, 13), // "ComponentType"
QT_MOC_LITERAL(5, 40, 4) // "type"

    },
    "Canvas\0componentAdded\0\0id\0ComponentType\0"
    "type"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->componentAdded((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< ComponentType(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Canvas::*)(const QString & , ComponentType );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::componentAdded)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::componentAdded(const QString & _t1, ComponentType _t2)
{
